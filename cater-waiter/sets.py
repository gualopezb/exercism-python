...
def check_drinks(drink_name, drink_ingredients):
    ...
    has_alcohol = any(ingredient for ingredient in drink_ingredients if ingredient in ALCOHOLS)
    cocktail_or_mocktail = "Cocktail" if has_alcohol else "Mocktail"
    return f"{drink_name} {cocktail_or_mocktail}"
...
def tag_special_ingredients(dish):
    ...
    return (dish_name, set(ingredient for ingredient in dish_ingredients if ingredient in SPECIAL_INGREDIENTS))
